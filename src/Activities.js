const Activities = () => {
  return (
    <div className="max-w-[1140px] w-full md:flex mt-[-75px] m-auto">
      <div className="relative p-4">
        <h3 className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-10 text-white text-2xl font-bold">
          Resorts
        </h3>
        <img
